...
const MesaQuanticaEspera: React.FC = () => {
  ...
  const CHECKOUT_LINK = "https://wa.me/5511931432736?text=Ol%C3%A1%20Jessica%2C%20quero%20entrar%20na%20lista%20de%20espera%20do%20curso%20de%20mesa%20quantica%20celestial%20%28n%C3%A3o%20apagar%29";
      ...
      <div className="relative min-h-[90vh] flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=2094&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat bg-fixed">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white space-y-8 pt-20">
          ...
          <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-1 rounded-full border border-white/20 mb-6 animate-fade-in-up">
            <span className="text-gold-accent font-semibold uppercase tracking-wider text-sm">Lista de Espera Aberta</span>
          </div>
          ...
          <p className="text-lg md:text-2xl text-slate-200 font-light max-w-2xl mx-auto leading-relaxed">
            Uma formação inédita e ao vivo com <strong className="text-white">Cíntia Camerin</strong>. Garanta seu lugar na lista de espera para ser avisado em primeira mão sobre a próxima turma.
          </p>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 text-slate-600">
                  <li className="flex justify-between border-b pb-2">
                    ...
                    <span className="font-bold text-slate-900">Datas a definir</span>
                  </li>
                  <li className="text-sm italic text-slate-500 pt-2">Entre na lista de espera para ter prioridade nas vagas</li>
                </ul>
              </div>
      ...
      <Section id="pricing" dark className="bg-slate-900 relative">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-lg mb-12">
            Minha missão é espalhar luz e ferramentas de autonomia. Cadastre-se na lista para receber o aviso de abertura antes de todo mundo.
          </p>
          ...
          <div className="bg-white text-slate-800 rounded-3xl shadow-2xl overflow-hidden border-4 border-gold-accent transform transition-all hover:scale-[1.01]">
            <div className="bg-gold-accent p-3 text-center">
              <span className="font-bold text-slate-900 uppercase tracking-widest text-sm">Vagas Limitadas na Próxima Turma</span>
            </div>
            ...
            <div className="p-8 md:p-12">
              <div className="flex flex-col md:flex-row gap-8 justify-center mb-8 text-left max-w-lg mx-auto">
                <ul className="space-y-4">
                  {[
                    "Aulas Ao Vivo com Cíntia Camerin",
              ...
              <Button onClick={handleCheckout} fullWidth variant="primary" className="text-lg md:text-xl py-5 shadow-gold-accent/20 shadow-xl">
                ENTRAR NA LISTA DE ESPERA
              </Button>
...
export default MesaQuanticaEspera;
